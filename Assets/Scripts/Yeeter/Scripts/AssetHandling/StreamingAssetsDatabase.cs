    ...
    public class StreamingAssetsDatabase
    {
        ...
        public static void LoadModules()
        {
            ...
            void AddMod(string path)
            {
                ...
                {
                    Debug.LogWarning("\t\tFailed to load mod at '" + path + "'.");
                }
            }
        ...
        public static void LoadActiveModules()
        {
            ...
            var loadOrder = File.ReadAllLines(
                Application.streamingAssetsPath + "/Settings/LoadOrder.txt"
            );
        ...
        public static void LoadSoundsFromActiveModules()
        {
